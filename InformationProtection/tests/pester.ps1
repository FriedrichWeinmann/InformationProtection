...
Remove-Module InformationProtection -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\InformationProtection.psd1"
Import-Module "$PSScriptRoot\..\InformationProtection.psm1" -Force
