<#
	.SYNOPSIS
		Installs the InformationProtection Module from github
		
	.DESCRIPTION
		This script installs the InformationProtection Module from github.
